...
export default function SignInPage() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-4">
      <Card className="relative w-full max-w-md border-zinc-800/50 bg-zinc-900/40 backdrop-blur-xl pt-8">
        {/* Card inner glow */}
        ...
        {/* Content */}
        <CardHeader className="pb-0 text-center space-y-0">
          <CardTitle className="text-lg font-bold bg-gradient-to-br from-zinc-200 to-zinc-400 bg-clip-text text-transparent">Welcome to Pyramid</CardTitle>
        </CardHeader>
